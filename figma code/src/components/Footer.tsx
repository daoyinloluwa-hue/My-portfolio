...
export default function Footer({ onNavigate }: { onNavigate: (p: Page) => void }) {
  return (
    <footer className="bg-[#201e21] rounded-tl-[100px] rounded-tr-[100px] overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-[80px] pt-[74px] pb-[48px]">
        <div className="flex items-start justify-between gap-12">
          {/* Left — CTA */}
          <div className="flex flex-col gap-10 max-w-[600px]">
            <div className="flex flex-col gap-4">
              <p className="font-['Montserrat',sans-serif] font-semibold text-[15px] text-[rgba(255,255,255,0.5)] uppercase tracking-[0.12em]">
                Available for freelance work, contracts, and full time opportunities.
              </p>
              <h2 className="font-['Montserrat',sans-serif] font-bold text-[38px] uppercase text-white leading-[1.15]">
            ...
            >
              <span className="font-['Montserrat',sans-serif] font-semibold text-[18px] text-black">
          ...
          {/* Right — nav + socials */}
          <div className="flex gap-16 shrink-0 pt-2">
              ...
              <nav className="flex flex-col gap-3">
                {navLinks.map(({ label, page }) => (
                  <button
                    ...
                    className="font-['Montserrat',sans-serif] font-semibold text-[18px] text-white text-left hover:text-[#6751a4] transition-colors duration-200"
                  >
                    {label}
                  </button>
                ))}
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-3">
                {socials.map(({ label, href, img }) => (
                  ...
                  >
                    <img src={img} alt={label} className="w-9 h-9 object-cover rounded-[8px]" />
        ...
        {/* Divider + copyright */}
        <div className="mt-16 pt-6 border-t border-[rgba(255,255,255,0.08)] flex items-center justify-between">
          <p className="font-['Montserrat',sans-serif] font-medium text-[13px] text-[rgba(255,255,255,0.3)]">
