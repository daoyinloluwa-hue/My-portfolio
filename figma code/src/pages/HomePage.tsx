...
const works = [
  {
    title: "iexplore",
    desc: "Designed to eliminate the social friction of planning, safety, and venue discovery.",
    cat: "Nightlife",
    type: "Mobile App",
    img: imgFrame427318621,
    img2: img278,
  },
  {
    title: "Grabby",
    desc: "An all-in-one SaaS platform that helps SMEs manage sales, inventory, and customer relationships.",
    cat: "SaaS",
    type: "Mobile App",
    img: imgFrame427318622,
    img2: null,
  },
  {
    title: "Cammy",
    desc: "A modern Order Management Dashboard UI that simplifies product selection and streamlines checkout.",
    cat: "Product Design",
    type: "Dashboard",
    img: imgFrame427318623,
    img2: null,
  },
  {
    title: "AfriReuse",
    desc: "A community reuse app where people give and receive items for free.",
    cat: "Product Design",
    type: "Mobile App",
    img: imgFrame427318624,
    img2: null,
  },
];
        ...
        <div className="max-w-[1280px] mx-auto flex gap-[17px] items-start">
          ...
          <div className="flex flex-col gap-[40px] px-[54px] py-[32px] w-[562px]">
            {works.map((w, i) => (
              <div
                key={i}
                className="bg-[#ccc] flex flex-col gap-[16px] px-[16px] py-[20px] rounded-[40px] sticky top-0 w-[454px] cursor-pointer group"
              >
                <div className="h-[275px] rounded-[40px] overflow-hidden w-full relative">
                  {w.img2 && (
                    <img alt="" src={w.img2} className="absolute inset-0 w-full h-full object-cover" />
                  )}
                  <img
                    alt={w.title}
                    src={w.img}
                ...
                <div className="flex flex-col gap-[8px] px-[4px]">
                  ...
                  <p className="font-['Montserrat',sans-serif] font-medium text-[16px] text-black leading-[1.4]">{w.desc}</p>
